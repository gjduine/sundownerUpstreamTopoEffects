% script to read and plot hovmoller diagrams during western regime case
...
Ti=title(strcat('(a) Western regime - PBL top valley [m agl]'),...
...
textBB=text(-119.45,2200,'A``','FontSize',14);


set(findall(gcf, '-property', 'FontSize'), 'FontSize', 18)
export_fig(strcat('FigS04a'),'-pdf')
